...
> **v5.0 Complete Source Sync — 10 July 2026:** Full Android source tree, game engine, Compose UI, resources, tests, Gradle wrapper, and GitHub Actions APK workflow are synchronized on `main`. App version: `5.0.0` (`versionCode 5`).
